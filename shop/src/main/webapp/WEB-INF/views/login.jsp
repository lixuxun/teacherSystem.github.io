...
<%--style="background-image: url(../image/tao.jpg)"   这个也可以访问，但是不理解--%>
<body onload="createCode()"
	  style=" background-image: url(${pageContext.request.contextPath }/image/denglu.jpg);background-repeat:no-repeat ;
