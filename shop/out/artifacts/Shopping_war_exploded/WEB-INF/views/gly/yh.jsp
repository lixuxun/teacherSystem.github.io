		...
		<ul>
			...
			<li>
				<dl>
					<dt>历史记录</dt>
					<dd>
						<a href="tzCgHistory">采购记录</a>
					</dd>
					<dd>
						<a href="tzXsHistory">销售记录</a>
					</dd>
				</dl>
			</li>	
		</ul>
				...
				<tbody id="list">
					<c:forEach items="${list}" var="list" varStatus="num">
						<tr>
							...
							<td id="position" class="center">
							<c:if test="${list.position == 0}">
									管理员
								</c:if>
							...
							<td id="idPass" class="center"><c:if test="${list.idPass == 0}">
									<a title="已验证" class="link_icon">&#89;</a>
								</c:if> <c:if test="${list.idPass == 1}">
